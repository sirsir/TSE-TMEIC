...
public class DProcessResultTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(DProcessResult.class).id("aaa", 1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_DProcessPlan() throws Exception {
        jdbcManager.from(DProcessResult.class).leftOuterJoin(DProcessPlan()).id("aaa", 1).getSingleResult();
    }
}