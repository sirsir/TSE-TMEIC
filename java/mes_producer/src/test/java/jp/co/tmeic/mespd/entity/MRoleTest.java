...
public class MRoleTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MRole.class).id("aaa").getSingleResult();
    }
    ...
    public void testLeftOuterJoin_MRoleAuthorityList() throws Exception {
        jdbcManager.from(MRole.class).leftOuterJoin(MRoleAuthorityList()).id("aaa").getSingleResult();
    }
    ...
    public void testLeftOuterJoin_MUsersRoleList() throws Exception {
        jdbcManager.from(MRole.class).leftOuterJoin(MUsersRoleList()).id("aaa").getSingleResult();
    }
}