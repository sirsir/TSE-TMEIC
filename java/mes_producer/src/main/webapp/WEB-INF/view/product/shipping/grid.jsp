  ...
  function createGrid() {
    ...
    grid.prop.colModel =
      [
        ...
        { name : 'shippingNo',   width : '110', align : 'left',   frozen : true, sortable : true, sorttype : 'text', editable : false, edittype : 'text',   editrules:{required : requiredOfShippingNo}, editoptions: {maxlength: 10}},
