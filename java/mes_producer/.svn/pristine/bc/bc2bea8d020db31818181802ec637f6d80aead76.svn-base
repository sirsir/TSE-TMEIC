...
public class MSpecProcessComponentNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MSpecProcessComponentNames extends PropertyName<MSpecProcessComponent> {

        /**
         * インスタンスを構築します。
         */
        public _MSpecProcessComponentNames() {
        }
         ...
         *            名前
         */
        public _MSpecProcessComponentNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MSpecProcessComponentNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
