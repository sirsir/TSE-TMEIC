  ...
  function createGrid() {
    ...
    grid.prop.colModel =
      [
        ...
        { name : 'productPlanNo',   width : '100', align : 'left',   frozen : true, sortable : true, sorttype : 'text', editable : false, edittype : 'text',   editrules:{required : requiredOfProductPlanNo}, editoptions: {maxlength: 10}},
