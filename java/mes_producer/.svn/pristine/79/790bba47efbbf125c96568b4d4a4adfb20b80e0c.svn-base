...
public class MBeforeProcessTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MBeforeProcess.class).id("aaa", 1, 1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_MProcessComponent() throws Exception {
        jdbcManager.from(MBeforeProcess.class).leftOuterJoin(MProcessComponent()).id("aaa", 1, 1).getSingleResult();
    }
}