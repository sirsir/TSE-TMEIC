...
public class DProductResultTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(DProductResult.class).id("aaa").getSingleResult();
    }
    ...
    public void testLeftOuterJoin_DProductPlan() throws Exception {
        jdbcManager.from(DProductResult.class).leftOuterJoin(DProductPlan()).id("aaa").getSingleResult();
    }
}